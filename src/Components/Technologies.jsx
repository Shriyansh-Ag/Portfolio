  ...
  return (
    <div className=" border-b border-neutral-800 pb-24">
        ...
        className="flex flex-wrap items-center justify-center gap-4">
            ...
            animate="animate"
            className="rounded-2xl border-4 border-neutral-800 p-4">
                <RiNodejsLine variants = {iconVariants(2)}
            initial = "initial"
            animate="animate"className="text-5xl text-green-400"/>
            </motion.div>
            <motion.div 
            variants = {iconVariants(3)}
            initial = "initial"
            animate="animate"
            className="rounded-2xl border-4 border-neutral-800 p-4">
                <SiExpress className="text-5xl text-grey-400"/>
            </motion.div>
            <motion.div 
            variants = {iconVariants(2)}
            initial = "initial"
            ...
            animate="animate"
            className="rounded-2xl border-4 border-neutral-800 p-4">
                <SiThreedotjs className="text-5xl "/>
            </motion.div>
            </motion.div>
    </div>
  )
